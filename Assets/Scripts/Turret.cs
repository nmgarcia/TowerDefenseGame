...
public class Turret : MonoBehaviour
{
    ...
    void shoot()
    {
        ...
        //TODO: AudioManager.instance.SetAudioClipForEffects(new AudioSource(), AudioClips_Effects.BULLET);
        //TODO: LevelManager.instance.Damage = LevelManager.instance.oldDamage;
    }
    ...
    void UpdateTarget()
    {
        ...
        foreach (GameObject enemy in enemies)
        {
            ...
            // Destroy baby turret because
            if (isChildTurret && distanceToEnemy <= 0.35f)
            {
                Destroy(gameObject);
            }
        ...
        if (closeEnemy != null && shortestDistance <= ViewDistance)
        {
